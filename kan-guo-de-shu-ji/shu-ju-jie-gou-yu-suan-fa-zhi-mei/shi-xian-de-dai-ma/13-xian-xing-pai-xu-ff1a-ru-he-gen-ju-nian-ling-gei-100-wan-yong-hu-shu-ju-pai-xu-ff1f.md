...
![](https://static001.geekbang.org/resource/image/53/3a/538f4aefb62df6171579293a87d9ca3a.jpg)
...
我总结一下，**计数排序只能用在数据范围不大的场景中**，如果数据范围 k 比要排序的数据 n 大很多，就**不**适合用**计数**排序了。而且，**计数**排序只能**给**非负整数**排序**，如果要排序的数据是其他类型的，要**将**其在不改变相对大小的情况下，转化为非负整数。
